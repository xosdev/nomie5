export default {
  ...
  translation: {
    settings: {
      ...
      "delete-warning": "This will destroy ALL data in LeLo. Are you absolutely sure?",
      destroy: "Destroy",
      "delete-warning-again": "So you REALLY want all ALL data in LeLo destroyed?",
      ...
      "tab-data": "Data",
      "tab-about": "About",
      "patron-official": "Official LeLo Patron",
      ...
      "translate-nomie": "Help Translate LeLo",
      ...
      "require-pin-description": "Require a pin to launch LeLo. Don't forget it!",
      "set-pin": "Set Lock Pin",
      "enable-advanced-buttons": "Advanced Tracker Buttons",
      "pin-requirements": "1 to 6 digits",
      "select-nomie-backup": "Select LeLo Backup...",
      "sign-out": "Sign Out",
    ...
    tracker: {
      ...
      "delete-from-nomie": "Delete from LeLo?",
      ...
      "note-description":
        "Combine multiple trackers together using their #hashtags. For example, #mood #sleep_quality. LeLo will then ask for values one by one.",
      step: "Range Step",
    ...
    "nomie-api": {
      ...
      "auto-import-description": "Auto import API logs when LeLo launches",
      "api-key": "API Key",
    ...
    export: {
      ...
      "backup-description":
        "Create an importable backup file. This allows you to transfer your data from one device to another using a single file (JSON) that contains ALL your LeLo data.",
